...
9. 이미지는 이렇게 걸 수 있습니다.
    ...
    ```
(예제)
   ![IPPLab](/assets/img/INU_logo.jpg)
...
10. 이미지 HTML 링크는 이렇게 걸 수 있습니다.
  ...
  ```
(예제)
   [![IPPLab](/assets/img/IPSCMLab_Logo.jpg)](https://sites.google.com/view/ipscmlab)
...
(예제)
  <!--  Code  -->
  To pring this message in the console, use `console.log('message')` and then we found that this is wonderfunl expression.
